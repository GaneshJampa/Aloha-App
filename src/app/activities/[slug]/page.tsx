        ...
        <>
            ...
            <div className="relative">
                <img src={activity.image}
                    className="absolute lg:top-0 object-cover w-full h-full" alt={activity.name} />
                <div className="relative">
                        ...
                        <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-2 gap-y-2 py-6 px-4">
                            {
                                activity.activities.map(act =>
                                    <div key={act.name} className="py-4 md:px-4 px-2 bg-white white rounded-lg">
                                        <div className="flex flex-row items-center">
                                            <div>
                                                <svg className="w-10 p-[8px] rounded-full text-[#008080] hover:bg-[#E6F2F2] transition ease-in-out duration-200" viewBox="0 0 24 24" fill="currentColor">
                                            ...
                                            <p className="text-[#001A1A] text-sm ml-2">{act.name}</p>
                                        </div>
                                    </div>
                                )
                            }
